...
Ext.define('statistics.StatisticsModel', {
...
statisticsGrid.getSelectionModel().on('selectionchange',
		function(selModel, selections) {
		statisticsGrid.down('#delete').setDisabled(selections.length === 0);
		});
...
Ext.application({
			...
			launch : function() {
				Ext.create('Ext.container.Viewport', {
							layout : 'border',
							items : [statisticsForm, statisticsGrid]
						});
			}
		});
