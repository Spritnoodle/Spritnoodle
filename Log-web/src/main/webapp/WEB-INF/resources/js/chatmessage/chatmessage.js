...
Ext.define('chatmessage.ChatMessageModel', {
...
var chatmessageGrid = new Ext.grid.GridPanel({
	id : 'chatmessageGrid',
	plugins : [ rowEditing ],
	store : store,
	region : 'center',
...
chatmessageGrid.getSelectionModel().on(
		'selectionchange',
		function(selModel, selections) {
			chatmessageGrid.down('#delete')
...
var clearForm = function() {
	...
	chatmessageForm.getForm().reset();
}

var queryForm = function() {
	Ext.Msg.alert('查询', '将开始执行查询！');
}
var chatmessageForm = new Ext.form.FormPanel({
	title : '消息查询',
	width : 200,
	height : 200,
	frame : true,
...
Ext.application({
	...
	launch : function() {
		Ext.create('Ext.container.Viewport', {
			layout : 'border',
			items : [ chatmessageForm, chatmessageGrid ]
		});
	}
});
